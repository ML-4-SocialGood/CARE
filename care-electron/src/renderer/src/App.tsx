...
const router = createHashRouter([
  ...
  {
    path: '/profile',
    element: <SitePage component={<Profile />} withHeader wrapperClass="profile" />
  },
  {
    path: '/profile/user',
    element: <SitePage component={<ProfileUser />} withHeader wrapperClass="profile" />
  },
  {
    path: '/about',
  ...
  {
    path: 'stoats',
    element: <SitePage component={<Stoats />} withHeader wrapperClass="stoats" />
  },
  {
    path: 'stoats/new',
    element: <SitePage component={<CreateStoat />} withHeader wrapperClass="new-stoat" />
  },
  {
    path: 'stoats/:stoatId',
    element: <SitePage component={<StoatProfile />} withHeader wrapperClass="stoats" />
  },
  {
    path: '/uploads',
  ...
  },
  {
    ...
    element: <SitePage component={<UploadPage />} withHeader wrapperClass="upload-page" />
  },
  {
    path: '/result',
...
function App() {
  ...
  // const getAccessTokenSilently = (_) => 'token'
