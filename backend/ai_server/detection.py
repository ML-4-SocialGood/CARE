...
def run(original_images_dir, output_images_dir, json_output_dir, yolo_model_path):
...
def main():
    ...
    run(original_images_dir, output_images_dir, json_output_dir, yolo_model_path)
