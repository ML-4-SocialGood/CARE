...
import upload from "@renderer/assets/upload.png";
import { acceptedFileTypes } from "@renderer/pages/upload/constants/acceptedFileTypes";
        ...
        <div className="progress-container">
          ...
          <div className="progress-wrapper">
            ...
            <img
              ...
              style={{
                left: `${
                  Math.floor((loadedFileCount / totalCount) * 100) - 2
                }%`,
              }}
            />
          </div>
    ...
    try {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        if (isJpgExtension && isJpegMime) {
          ...
          formData.append("relativePath", file._webkitRelativePath); // Send the folder structure

          // Send the file to the server
          await apiClient("/api/users/images/upload", {
            method: "POST",
            body: formData,
          });
    ...
    <>
      ...
      >
        <button
          className={clsx(
            "drop-zone__button",
            dragging && `drop-zone__button-active`
          )}
          type="button"
        ...
        >
          <img
            className="drop-zone__button__icon"
            src={upload}
            alt="Upload images"
          />
        ...
        <div className="progress-container">
          ...
          <div className="progress-wrapper">
            ...
            <img
              ...
              style={{
                left: `${
                  Math.floor((loadedFileCount / files.length) * 100) - 2
                }%`,
              }}
            />
          </div>
